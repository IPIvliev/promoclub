# RailsAdmin config file. Generated on August 24, 2014 13:51
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Promoclub', 'Admin']
  ...
  # config.excluded_models = ['Article', 'City', 'Country', 'Message', 'Relationship', 'State', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Article', 'City', 'Country', 'Message', 'Relationship', 'State', 'User']
  ...
  #     configure :followed_users, :has_many_association 
  #     configure :reverse_relationships, :has_many_association 
